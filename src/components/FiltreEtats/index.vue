<template>
  <div>
    ...
    <el-select
      v-model="periodTypeSelected"
      placeholder="Select"
      @change="handlePeriodTypeChanged"
    >
      <el-option
    ...
    <el-button
      ...
      @click="handleRefreshWithNewFilterParams"
    />
  </div>
</template>
...
export default class extends Vue {
    private periodType = 'date'// etatsmodule.periode
    private datePickerPeriodType = 'date'
    ...
    private formatedSelectedDate = ''
    private isDatePickerDisabled = false
    private isDatePickerVisible = false
    private isFilterButtonActive = false
    private beginMonthSelected = 1
    private endMonthSelected = 2
...
private periodTypeSelected : periodTypeSelection = {
  ...
  private handleDateChanged(date:any) {
    ...
    if (!this.isFilterButtonActive) { this.isFilterButtonActive = true }
  }
