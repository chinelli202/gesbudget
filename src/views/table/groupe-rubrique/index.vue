  ...
  <div class="dashboard-editor-container">
    ...
    <el-row>
      <el-col :span="12">
        <div class="grid-content bg-purple">
          <h3>Budget {{ recapData.header.name }} - {{ periodeLabel }}</h3>
        </div>
      </el-col>
      <el-col :span="12">
        <div
        ...
        >
          <filtre-etats @filter-refreshed="handleFiltreRefreshed" />
        </div>
      </el-col>
    </el-row>
    <panel-group
    ...
    <el-row :gutter="8">
      ...
      <el-col
        ...
        :span="12"
      >
        <bar-chart :recap-months="monthsRecapCollection" />
      </el-col>
      <!-- <el-col :offset="chartOffset" :span="12"
        >
    ...
    <!-- Summary Table -->
    <summary-table
      v-if="recapData.type && recapData.type!= 'ligne'"
      :recap-data="recapData"
    />
    <h3
      v-if="recapData.type == 'ligne'"
      class="box-card"
    >
      Récapitulatif
    </h3>
...
export default class extends Vue {
    ...
    private periodeLabel = ''
    private isPeriodeJour = true
    private isPeriodeMois = false
    private isPeriodeIntervalle = false
