<template>
  <div>
    ...
    >
      ...
      />
      <el-step
        title="Maquette Fonctionnement"
        icon="el-icon-upload"
      />
      <el-step
        title="Maquette Mandat"
        icon="el-icon-upload"
      />
    </el-steps>
    <el-row
      ...
      <el-card class="box-card">
        ...
        >
          <el-form-item label="Libellé">
            <el-input v-model="budgetInfo.label" />
          </el-form-item>
          <el-form-item label="Description">
            <el-input
              v-model="budgetInfo.description"
              type="textarea"
            />
          </el-form-item>
          <el-col span="8">
...
export default class extends Vue {
    ...
    private loadMaquette() {
      getMaquetteActive('SNHSIEGE', this.params).then((response) => {
        ...
        const maquetteFonctionnement = response.data.domaines[0]
        const maquetteMandat = response.data.domaines[1]
      })
    }
}
