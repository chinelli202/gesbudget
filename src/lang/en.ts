export default {
  route: {
    ...
    engagementDetail: 'Detail',
    engagementDetailView: 'Engagement',
    ...
    navetats: 'Navigateur Etats',
    elementMandat: 'Mandat',
    elementFonctionnement: 'Etat Fonctionnement',
    etatsBudget: 'Etats Budget',
    tinymce: 'Tinymce',
    markdown: 'Markdown',
